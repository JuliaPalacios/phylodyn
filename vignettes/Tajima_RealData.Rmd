...
```{r}
library(seqinr)
tree1<-read.nexus("~/Documents/Covid_Analysis/alignment/BEAST/mcct_Germany")
...
mu<-reg$coefficients[[1]]*ncol(data.matrix)
...
plot_BNPR(res_BNPR3)
,heatmaps=FALSE,heatmap_labels = FALSE,ylab="Ne(t)",main="(A) Ne(t) BESTT")
```