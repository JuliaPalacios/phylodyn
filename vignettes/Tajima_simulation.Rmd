---
title: "Tajima inference from a simulation"
...
initial<-initial_tajima(data1,name="OldExp_10",mu=40,npoints=49,fact=1)


#intial MCMC
setupchain<-initial_MCMC(initial,ngrid=50,mu=40,n=10,alpha=.1,fact=1)
