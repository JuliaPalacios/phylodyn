...
#Extract sequence names and sampling times from the fasta label. Sequeences 
In this example we <sequence name>_<sampling time>
```{r,}
seq_names<-c()
samp_times<-c()
sequences<-list()
...
graph_gene_tree_mut(oldsuff$nodes,mutations)
```
